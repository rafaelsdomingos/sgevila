...
<div class="container-fluid">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title fw-semibold">Cadastro de Cursos</h5>
            <div>
            ...
            <form method="POST" action="{{route('cursos.store')}}" class="needs-validation" novalidate>
                ...
                <div class="row">
                    <div class="col-md-10 mb-3">
                        ...
                        <input class="form-control" name="nome" type="text" value="" aria-label="nome do curso" required>
                ...
                <div class="row">
                    <div class="col-sm-4 mb-3">
                        ...
                        <select class="form-select" aria-label="Modalidade" name="modalidade" required>
                            <option ></option>
                    ...
                    <div class="col-sm-8 mb-3">
                        ...
                        <input class="form-control" name="descricao" type="text" aria-label="descrição" required>
